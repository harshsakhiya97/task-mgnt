...
- **Phone numbers:** taken from each user's profile. 10-digit Indian numbers get `91` added. A user with no valid number is skipped, and WhatsApp Logs shows it.
...
- **Delivery log:** sidebar → **WhatsApp Logs**.
